<%@ Page Language="C#" AutoEventWireup="true" CodeFile="portfolio.aspx.cs" Inherits="PreviewDotnetTemplates1ColPortfolioPortfolio" %>
...
<head runat="server">
	...
	<title>KarwanTech Portfolio - Bootstrap Template</title>
	<!-- Bootstrap Core CSS -->
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a id="A1" href="contact.htm" runat="server">Contact</a></li>
					<li>
						<!-- add search form -->
